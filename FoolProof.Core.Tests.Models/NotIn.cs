...
namespace FoolProof.Core.Tests.Models
{
    public class NotIn
    {
        public class SingleValueModel<T> : ValidationModelBase
        {
            ...
            [Display(Description = "DateNotIn: Most not be in [01/01/2025, 02/02/2025, 03/03/2025, 04/04/2025, 05/05/2025]")]
            [NotIn<DateOnly>("01/01/2025", "02/02/2025", "03/03/2025", "04/04/2025", "05/05/2025")]
            [DataType(DataType.Date)]
            public DateOnly? DateNotIn { get; set; }

            [Display(Description = "TimeNotIn: Most not be in [01:00, 01:30, 02:00, 02:30, 03:00]")]
        ...
        public class DateTimeListModel : ValidationModelBase
        {
            ...
            [Display(Description = "DateTimeNotIn: Most not be in [01/01/2025 01:00, 02/02/2025 02:00, 03/03/2025 03:00, 04/04/2025 04:00, 05/05/2025 05:00]")]
            [NotIn<DateTime>("01/01/2025 01:00", "02/02/2025 02:00", "03/03/2025 03:03", "04/04/2025 04:00", "05/05/2025 05:00")]
            [DataType(DataType.DateTime)]
        ...
        public class In16ListModel : ValidationModelBase
        {
            ...
            [Display(Description = "ValueNotIn: Most not be in [-5, -1, 0, 1, 5]")]
